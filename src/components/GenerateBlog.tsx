              ...
              {!generationComplete ? (
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Your blog post has been generated successfully! Redirecting
                    to create page...
                  </p>
                </div>
              )}
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-2xl p-8">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <p className="ml-3 text-gray-700 dark:text-gray-300">
                  <span className="font-medium">Include keywords:</span> Mention
                  important SEO keywords for better optimization
                </p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 mt-1">
