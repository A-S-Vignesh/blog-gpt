    ...
    <>
      ...
      <section className="py-16 px-6 sm:px-16 md:px-20 lg:px-28">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Join creators from 10+ countries who use The Blog GPT daily
          </p>
        </div>
          ...
          {[
            {
              ...
              role: "Tech Blogger",
              content:
                "The Blog GPT has cut my writing time in half while improving my SEO rankings. The AI suggestions are incredibly helpful!",
            },
            {
              name: "Michael Chen",
              role: "Marketing Director",
              content:
                "Our content team produces 3x more articles since switching to The Blog GPT. The quality is consistently excellent.",
            },
            {
              name: "Emma Rodriguez",
              role: "Travel Writer",
              content:
                "As a solo creator, The Blog GPT feels like having a professional writing partner. The image integration is seamless!",
            },
