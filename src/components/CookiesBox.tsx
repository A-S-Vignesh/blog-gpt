  ...
  return (
    <div className="fixed bottom-6 right-6 z-9999">
      ...
      >
        {/* MAIN VIEW */}
        {!showMore && (
          <div className="flex flex-col pt-9 px-6 pb-6 relative">
            {/* Cookie Icon */}
            ...
            <h5 className="text-sm font-semibold mb-2 text-left mr-auto text-zinc-700 dark:text-zinc-200">
              Your privacy is important to us
            </h5>

            <p className="w-full mb-4 text-sm text-justify text-zinc-600 dark:text-zinc-300">
              We process your personal information to measure and improve our
              website and provide personalised content.
              <br />
              For more details, read our{" "}
              <Link
                href={"/cookies-policy"}
                className="text-sm font-semibold cursor-pointer hover:text-[#634647] dark:hover:text-[#ddad81] underline underline-offset-2"
              >
                Cookies Policy
              </Link>
              .
        ...
        {showMore && (
          <div className="flex flex-col pt-6 px-6 pb-6">
            <h5 className="text-sm font-bold mb-2 text-zinc-700 dark:text-zinc-200">
              Cookie Preferences
            </h5>

            <p className="text-sm text-zinc-600 dark:text-zinc-300 mb-4">
              Select which cookies you want to allow. You can disable analytics
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-xs bg-zinc-200 dark:bg-zinc-700 px-2 py-[2px] rounded text-zinc-700 dark:text-zinc-300">
                  Always On
                </span>
              </div>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-1">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div
                    className="w-11 h-5 bg-zinc-300 peer-focus:outline-none rounded-full 
                    peer dark:bg-zinc-700 peer-checked:bg-[#ddad81]"
                  ></div>
                  <span
                    className="absolute left-1 top-[2px] w-4 h-4 bg-white dark:bg-zinc-900 rounded-full 
